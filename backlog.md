...
| US06 | As a PMO, I want to automate the engineering metrics pipeline so that metrics are updated regularly without manual intervention | GitHub Actions workflow that automatically extracts metrics and updates datasets that feeds dashboards | High | Sprint 4 | Done |
